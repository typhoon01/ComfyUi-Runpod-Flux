...
#	"https://civitai.com/api/download/models/708635?token=$CIVITAI_TOKEN" #https://civitai.com/models/573152?modelVersionId=708635
	...
	"https://civitai.com/api/download/models/344487?token=$CIVITAI_TOKEN"
)
...
LORA_MODELS=(
#  "https://civitai.com/api/download/models/1729305?token=$CIVITAI_TOKEN"
#  "https://civitai.com/api/download/models/1793245?token=$CIVITAI_TOKEN"
#  "https://civitai.com/api/download/models/1726620?token=$CIVITAI_TOKEN"
#  "https://civitai.com/api/download/models/1720073?token=$CIVITAI_TOKEN"
)
...
HYPERLORA_CLIP_PROC=(
    "https://huggingface.co/openai/clip-vit-large-patch14/raw/main/preprocessor_config.json"
)
...
#    fi
    ...
    provisioning_get_models \
        ...
        "${ULTRALYTICS_MODELS[@]}"
    provisioning_get_models \
        "${WORKSPACE}/ComfyUI/models/hyper_lora/clip_processor/clip_vit_large_14_processor/" \
        "${HYPERLORA_CLIP_PROC[@]}"
    provisioning_get_models \
        "${WORKSPACE}/ComfyUI/models/hyper_lora/clip_vit/clip_vit_large_14/" \
        "${HYPERLORA_CLIP_VIT[@]}"
    provisioning_get_models \
        "${WORKSPACE}/ComfyUI/models/hyper_lora/hyper_lora/sdxl_hyper_id_lora_v1_fidelity/" \
        "${HYPERLORA_MODELS_FID[@]}"
